...
function eh_cmb2_render_star_rating_field_callback( $field, $value, $object_id, $object_type, $field_type_object ) {
	// enqueue styles
	wp_enqueue_style( 'star-rating-metabox-css', plugins_url( 'beverage-reviews/vendors/star-rating-field-type/css/star-rating-field-type.css' ), array( 'cmb2-styles' ), 'all', false );
	?>
